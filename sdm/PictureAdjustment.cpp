...
PictureAdjustment::PictureAdjustment(void* libHandle, int64_t cookie) {
    sInstance = this;
    ...
    disp_api_get_global_pa_range = reinterpret_cast<int32_t (*)(int64_t, uint32_t, void*)>(
        dlsym(mLibHandle, "disp_api_get_global_pa_range"));
    disp_api_get_global_pa_config =
        reinterpret_cast<int32_t (*)(int64_t, uint32_t, uint32_t*, void*)>(
