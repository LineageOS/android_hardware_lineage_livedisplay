...
ColorBalance::ColorBalance(void* libHandle, int64_t cookie) {
    ...
    disp_api_get_global_color_balance_range =
        reinterpret_cast<int32_t (*)(int64_t, uint32_t, void*)>(
    ...
    disp_api_get_num_display_modes =
        reinterpret_cast<int32_t (*)(int64_t, uint32_t, int32_t, int32_t*, uint32_t*)>(
